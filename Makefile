#
# OMNeT++/OMNEST Makefile for mqttsn
#
# This file was generated with the command:
#  opp_makemake --nolink -f --deep -O out -KINET4_4_PROJ=../inet4.4 -DINET_IMPORT -I. -I$$\(INET4_4_PROJ\)/src -L$$\(INET4_4_PROJ\)/src -lINET$$\(D\) -d src -X.
#
